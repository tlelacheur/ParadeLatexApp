...
def create_booklet(num_q=20, num=5):
    ...
    tex_diagram_template_path = (
        currfile_dir / "number_lines_worksheet_diagram_template.tex"
    )

    filename = "nl_" + timestamp 
    ...
    pdf_path = currfile_dir_out / f"{filename}_q.pdf"
    aux_path = currfile_dir_out / "temp"
    # answers
    tex_output_path_ans = currfile_dir_out / f"{filename}_ans.tex"
    pdf_path_ans = currfile_dir_out / f"{filename}_ans.pdf"
